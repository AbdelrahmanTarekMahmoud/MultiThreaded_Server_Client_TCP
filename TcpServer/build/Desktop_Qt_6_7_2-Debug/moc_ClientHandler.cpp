...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finishedProcessing((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        ...
        }
        {
            ...
            if (_t _q_method = &ClientHandler::finishedProcessing; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ClientHandler::finishedProcessing(const QByteArray & _t1)
{
